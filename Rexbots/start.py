...
# =========================================================
# Wallhaven Image Fetcher — ALL CATEGORIES
# =========================================================

WALLHAVEN_API_KEY = "FsXt5pwoerVZrsV3DwhRctls8YzUev9H"

# categories=111 → General + Anime + People teeno se photos
...
WALLHAVEN_QUERIES = [
    ...
    "london+cityscape",
    "dubai+skyline",
    "hong+kong+neon+night",
    "abandoned+building+urban",
