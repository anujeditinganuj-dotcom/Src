...
# =========================================================
# Wallhaven Anime Image Fetcher — ALL CATEGORIES
# =========================================================
...
ANIME_QUERIES = [
    ...
    "anime+portrait+face",
    "anime+girl+close+up",
    "anime+beautiful+face",

    # School & Uniform
    "anime+school+girl",
    "anime+school+uniform",
    "anime+sailor+uniform",
    ...
    "anime+blue+hair+girl",
    "anime+white+hair+girl",
    "anime+silver+hair+girl",
    "anime+red+hair+girl",
    "anime+blonde+anime+girl",
    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(url, timeout=aiohttp.ClientTimeout(total=10)) as resp:
                ...
                # Agar is query mein images nahi mili to bina query ke try karo
                if not images:
                    url_fallback = (
                        f"https://wallhaven.cc/api/v1/search"
                        f"?categories=010"
...
async def send_start(client: Client, message: Message):
    ...
    # Wallhaven se random anime image fetch karo
...
async def button_callbacks(client: Client, callback_query: CallbackQuery):
    ...
    if data == "dev_info":
        ...
        bot = await client.get_me()
        # Wallhaven se naya random anime image — home button pe bhi
        photo_url = await fetch_random_image()
