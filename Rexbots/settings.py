...
ICON_HELP     = "5431376038628171216"
ICON_GEAR     = "5431604517873629479"
ICON_INFO     = "5431449001532594347"
ICON_CHANNEL  = "5431376038628171217"
ICON_DEV      = "5431604517873629480"
ICON_CLOSE    = "5431449001532594348"
ICON_PAYMENT  = "5431376038628171218"
ICON_LIST     = "5431604517873629481"
ICON_STATS    = "5431449001532594349"
ICON_DELETE   = "5431376038628171219"
ICON_IMAGE    = "5431604517873629482"
ICON_EDIT     = "5431449001532594350"
ICON_HOME     = "5431376038628171220"

# ======================================================
# Helper: Build Main Settings Keyboard
# ======================================================
    ...
    return InlineKeyboardMarkup([
        [
            InlineKeyboardButton(
                "📜 ᴄᴏᴍᴍᴀɴᴅs ʟɪsᴛ",
                callback_data="cmd_list_btn",
                icon_custom_emoji_id=ICON_LIST,
        ...
        [
            InlineKeyboardButton(
                "🗑 ᴅᴜᴍᴘ ᴄʜᴀᴛ",
                callback_data="dump_chat_btn",
                icon_custom_emoji_id=ICON_DELETE,
        ...
        [
            InlineKeyboardButton(
                "🖼 ᴛʜᴜᴍʙɴᴀɪʟ",
                callback_data="thumb_btn",
                icon_custom_emoji_id=ICON_IMAGE,
                style=ButtonStyle.PRIMARY
            ),
            InlineKeyboardButton(
                "📝 ᴄᴀᴘᴛɪᴏɴ",
                callback_data="caption_btn",
                icon_custom_emoji_id=ICON_EDIT,
                style=ButtonStyle.PRIMARY
            )
        ],
        [
...
# ======================================================
# Helper: Build Settings Text
# ======================================================
def build_settings_text(user_id: int, is_premium: bool) -> str:
...
# ======================================================
# Helper: Back + Close keyboard
# ======================================================
def back_close_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[
        InlineKeyboardButton(
            "⬅️ ʙᴀᴄᴋ",
...
async def settings_menu(client: Client, message: Message):
    ...
    await message.reply_text(
        build_settings_text(user_id, is_premium),
        reply_markup=build_settings_keyboard(),
        parse_mode=enums.ParseMode.HTML
    )

# ======================================================
# /commands - Direct Commands List
# ======================================================
...
async def set_dump_chat(client: Client, message: Message):
    ...
    if arg == "clear":
        ...
        return await message.reply_text(
            "✅ <b>Dump Chat Cleared Successfully</b>",
            parse_mode=enums.ParseMode.HTML
        )
